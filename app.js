...
const MOUNT_SLOTS=[
{id:'N1',n:1,room:'Sala Norte',label:'Pared norte · izquierda',x:-13.4,y:2.18,z:-10.78,ry:0,mx:12,my:4.4},
{id:'N2',n:2,room:'Sala Norte',label:'Pared norte · centro',x:-9.4,y:2.18,z:-10.78,ry:0,mx:24,my:4.4},
{id:'N3',n:3,room:'Sala Norte',label:'Pared oeste · norte',x:-16.28,y:2.18,z:-7.0,ry:Math.PI/2,mx:3,my:14.7},
{id:'N4',n:4,room:'Sala Norte',label:'Pared oeste · media',x:-16.28,y:2.18,z:-3.8,ry:Math.PI/2,mx:3,my:27.9},
{id:'N5',n:5,room:'Sala Norte',label:'Tabique superior izquierdo',x:-11.5,y:2.18,z:-6.74,ry:Math.PI,mx:18,my:22.1},
{id:'E1',n:6,room:'Sala Este',label:'Pared central derecha · izquierda',x:5.9,y:2.18,z:-2.42,ry:0,mx:72,my:39.7},
{id:'E2',n:7,room:'Sala Este',label:'Pared central derecha · derecha',x:9.4,y:2.18,z:-2.42,ry:0,mx:82,my:39.7},
{id:'E3',n:8,room:'Sala Este',label:'Pared este · norte',x:16.28,y:2.18,z:-6.6,ry:-Math.PI/2,mx:97,my:22.1},
{id:'E4',n:9,room:'Sala Este',label:'Pared este · media',x:16.28,y:2.18,z:-2.8,ry:-Math.PI/2,mx:97,my:32.4},
{id:'E5',n:10,room:'Sala Este',label:'Pared norte · derecha',x:11.9,y:2.18,z:-10.78,ry:0,mx:84,my:4.4},
{id:'S1',n:11,room:'Sala Sur',label:'Pared este · media sur',x:16.28,y:2.18,z:3.0,ry:-Math.PI/2,mx:97,my:53.0},
{id:'S2',n:12,room:'Sala Sur',label:'Pared este · sur',x:16.28,y:2.18,z:7.2,ry:-Math.PI/2,mx:97,my:72.1},
{id:'S3',n:13,room:'Sala Sur',label:'Pared sur · derecha',x:10.6,y:2.18,z:10.78,ry:Math.PI,mx:81,my:92.6},
{id:'S4',n:14,room:'Sala Sur',label:'Pared sur · centro derecha',x:6.3,y:2.18,z:10.78,ry:Math.PI,mx:68,my:92.6},
{id:'S5',n:15,room:'Sala Sur',label:'Panel vertical derecho',x:8.10,y:1.75,z:3.7,ry:Math.PI/2,mx:75,my:69.1},
{id:'O1',n:16,room:'Sala Oeste',label:'Pared oeste · media sur',x:-16.28,y:2.18,z:2.2,ry:Math.PI/2,mx:3,my:50.0},
{id:'O2',n:17,room:'Sala Oeste',label:'Pared oeste · sur',x:-16.28,y:2.18,z:6.4,ry:Math.PI/2,mx:3,my:69.1},
{id:'O3',n:18,room:'Sala Oeste',label:'Pared sur · izquierda',x:-11.8,y:2.18,z:10.78,ry:Math.PI,mx:16,my:92.6},
{id:'O4',n:19,room:'Sala Oeste',label:'Pared sur · centro izquierda',x:-7.5,y:2.18,z:10.78,ry:Math.PI,mx:29,my:92.6},
{id:'O5',n:20,room:'Sala Oeste',label:'Tabique en L · interior',x:-7.7,y:2.18,z:1.52,ry:Math.PI,mx:29,my:42.6},
{id:'C1',n:21,room:'Sala Norte',label:'Pared central · frente izquierdo',x:-5.8,y:1.78,z:-3.42,ry:0,mx:39,my:34.6},
{id:'C2',n:22,room:'Sala Norte',label:'Pared central · frente centro',x:-2.8,y:1.78,z:-3.42,ry:0,mx:47,my:34.6},
{id:'C3',n:23,room:'Sala Norte',label:'Pared central · frente derecho',x:0.2,y:1.78,z:-3.42,ry:0,mx:55,my:34.6},
{id:'C4',n:24,room:'Sala Oeste',label:'Pared central · reverso izquierdo',x:-5.6,y:1.78,z:-3.78,ry:Math.PI,mx:39,my:44.1},
{id:'C5',n:25,room:'Sala Oeste',label:'Pared central · reverso derecho',x:-2.2,y:1.78,z:-3.78,ry:Math.PI,mx:47,my:44.1},
{id:'C6',n:26,room:'Sala Sur',label:'Panel central · frente',x:0.0,y:1.75,z:3.60,ry:0,mx:50,my:63.2},
{id:'C7',n:27,room:'Sala Sur',label:'Panel central · reverso',x:0.0,y:1.75,z:3.20,ry:Math.PI,mx:50,my:72.1},
{id:'C8',n:28,room:'Sala Sur',label:'Panel derecho · reverso',x:8.55,y:1.75,z:3.7,ry:-Math.PI/2,mx:79,my:69.1}
];
